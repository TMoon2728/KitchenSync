...
import type { MealPlan, PantryItem, Recipe, UserProfile } from '../types';
...
const ShoppingList: React.FC<ShoppingListProps> = ({ mealPlan, pantry, recipes, userProfile }) => {
                            ...
                            <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-xl py-2 z-20 border border-gray-100 animate-scale-in">
                                ...
                                {userProfile.groceryStores.length > 0 ? (
                                    ...
                                    <div className="px-4 py-3 text-sm text-gray-500 italic">
                                        ...
                                        <a href="#/profile" className="text-blue-500 hover:underline">Add in Profile</a>
                                    </div>
                                )}
                            </div>
                        )}
                                    ...
                                    {items.map(item => {
                                        ...
                                        return (
                                            <div 
                                                ...
                                                className={`flex items-center p-3 rounded-xl border-2 transition-all cursor-pointer group select-none ${
                                                    isChecked 
