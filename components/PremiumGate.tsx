    ...
    return (
        <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center p-6 text-center animate-fade-in">
                <div className="bg-white dark:bg-gray-800/90 backdrop-blur-md p-8 rounded-3xl shadow-2xl max-w-md border border-white/50 relative overflow-hidden group">
                    ...
                    <p className="text-gray-600 mb-6 leading-relaxed">
                        Upgrade to the <span className="font-bold text-gray-800 dark:text-gray-100">Executive Chef</span> tier to access unlimited AI Architect plans, the Sous Chef assistant, and advanced recipe generation.
                    </p>
